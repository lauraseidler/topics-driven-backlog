<template>
    <b-form @submit.prevent="submit">
        ...
        <b-form-group label="Start date" label-for="sprint-start-date">
            <b-form-input id="sprint-start-date" type="date" v-model="data.start_date" required></b-form-input>
        </b-form-group>

        <b-form-group label="End date" label-for="sprint-end-date">
            <b-form-input id="sprint-end-date" type="date" v-model="data.end_date" required></b-form-input>
        </b-form-group>
